...
function loadUpdate(event){
  ...
  xhr.send(params); // this builds out the post request query
}
...
const loadDelete = (id) => {
  ...
  xhr.send(id); // this builds out the post request query
}
